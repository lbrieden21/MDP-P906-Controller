...
# Form implementation generated from reading ui file 'gui_source/mdp_gui_template/graphics.ui'
#
...
class Ui_DialogGraphics(object):
    def setupUi(self, DialogGraphics):
        ...
        DialogGraphics.setMinimumSize(QtCore.QSize(280, 702))
        DialogGraphics.setMaximumSize(QtCore.QSize(280, 702))
        ...
        self.labelDeviceLayout = QtWidgets.QLabel(DialogGraphics)
        self.labelDeviceLayout.setMinimumSize(QtCore.QSize(0, 24))
        self.labelDeviceLayout.setMaximumSize(QtCore.QSize(999, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.labelDeviceLayout.setFont(font)
        self.labelDeviceLayout.setAlignment(QtCore.Qt.AlignCenter)
        self.labelDeviceLayout.setObjectName("labelDeviceLayout")
        self.horizontalLayout_7.addWidget(self.labelDeviceLayout)
        ...
        self.comboDeviceLayout = QtWidgets.QComboBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.comboDeviceLayout.setFont(font)
        self.comboDeviceLayout.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.comboDeviceLayout.setEditable(False)
        self.comboDeviceLayout.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContentsOnFirstShow)
        self.comboDeviceLayout.setObjectName("comboDeviceLayout")
        self.comboDeviceLayout.addItem("")
        self.comboDeviceLayout.addItem("")
        self.horizontalLayout_6.addWidget(self.comboDeviceLayout)
        self.verticalLayout.addLayout(self.horizontalLayout_6)
        self.labelGraphLayout = QtWidgets.QLabel(DialogGraphics)
        self.labelGraphLayout.setMinimumSize(QtCore.QSize(0, 24))
        self.labelGraphLayout.setMaximumSize(QtCore.QSize(999, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.labelGraphLayout.setFont(font)
        self.labelGraphLayout.setAlignment(QtCore.Qt.AlignCenter)
        self.labelGraphLayout.setObjectName("labelGraphLayout")
        self.verticalLayout.addWidget(self.labelGraphLayout)
        self.horizontalLayoutGraphLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayoutGraphLayout.setSpacing(6)
        self.horizontalLayoutGraphLayout.setObjectName("horizontalLayoutGraphLayout")
        self.comboGraphLayout = QtWidgets.QComboBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.comboGraphLayout.setFont(font)
        self.comboGraphLayout.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.comboGraphLayout.setEditable(False)
        self.comboGraphLayout.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContentsOnFirstShow)
        self.comboGraphLayout.setObjectName("comboGraphLayout")
        self.comboGraphLayout.addItem("")
        self.comboGraphLayout.addItem("")
        self.horizontalLayoutGraphLayout.addWidget(self.comboGraphLayout)
        self.verticalLayout.addLayout(self.horizontalLayoutGraphLayout)
        ...
        self.labelGraphTriggerDevice = QtWidgets.QLabel(DialogGraphics)
        self.labelGraphTriggerDevice.setMinimumSize(QtCore.QSize(0, 24))
        self.labelGraphTriggerDevice.setMaximumSize(QtCore.QSize(999, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.labelGraphTriggerDevice.setFont(font)
        self.labelGraphTriggerDevice.setAlignment(QtCore.Qt.AlignCenter)
        self.labelGraphTriggerDevice.setObjectName("labelGraphTriggerDevice")
        self.verticalLayout.addWidget(self.labelGraphTriggerDevice)
        self.horizontalLayoutGraphTriggerDevice = QtWidgets.QHBoxLayout()
        self.horizontalLayoutGraphTriggerDevice.setSpacing(6)
        self.horizontalLayoutGraphTriggerDevice.setObjectName("horizontalLayoutGraphTriggerDevice")
        self.comboGraphTriggerDevice = QtWidgets.QComboBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.comboGraphTriggerDevice.setFont(font)
        self.comboGraphTriggerDevice.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.horizontalLayoutGraphTriggerDevice.addWidget(self.comboGraphTriggerDevice)
        self.verticalLayout.addLayout(self.horizontalLayoutGraphTriggerDevice)
        self.labelGraphAutostart = QtWidgets.QLabel(DialogGraphics)
        self.labelGraphAutostart.setMinimumSize(QtCore.QSize(0, 24))
        self.labelGraphAutostart.setMaximumSize(QtCore.QSize(999, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.labelGraphAutostart.setFont(font)
        self.labelGraphAutostart.setAlignment(QtCore.Qt.AlignCenter)
        self.labelGraphAutostart.setObjectName("labelGraphAutostart")
        self.verticalLayout.addWidget(self.labelGraphAutostart)
        self.horizontalLayoutGraphAutostart = QtWidgets.QHBoxLayout()
        self.horizontalLayoutGraphAutostart.setSpacing(6)
        self.horizontalLayoutGraphAutostart.setObjectName("horizontalLayoutGraphAutostart")
        self.comboGraphAutostart = QtWidgets.QComboBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.comboGraphAutostart.setFont(font)
        self.comboGraphAutostart.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.comboGraphAutostart.addItem("")
        self.comboGraphAutostart.addItem("")
        self.horizontalLayoutGraphAutostart.addWidget(self.comboGraphAutostart)
        self.spinGraphAutostartThreshold = QtWidgets.QDoubleSpinBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        ...
        self.horizontalLayoutGraphAutostart.addWidget(self.spinGraphAutostartThreshold)
        self.verticalLayout.addLayout(self.horizontalLayoutGraphAutostart)
        self.labelGraphAutostop = QtWidgets.QLabel(DialogGraphics)
        self.labelGraphAutostop.setMinimumSize(QtCore.QSize(0, 24))
        self.labelGraphAutostop.setMaximumSize(QtCore.QSize(999, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.labelGraphAutostop.setFont(font)
        self.labelGraphAutostop.setAlignment(QtCore.Qt.AlignCenter)
        self.labelGraphAutostop.setObjectName("labelGraphAutostop")
        self.verticalLayout.addWidget(self.labelGraphAutostop)
        self.horizontalLayoutGraphAutostop = QtWidgets.QHBoxLayout()
        self.horizontalLayoutGraphAutostop.setSpacing(6)
        self.horizontalLayoutGraphAutostop.setObjectName("horizontalLayoutGraphAutostop")
        self.comboGraphAutostop = QtWidgets.QComboBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        self.comboGraphAutostop.setFont(font)
        self.comboGraphAutostop.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.comboGraphAutostop.addItem("")
        self.comboGraphAutostop.addItem("")
        self.horizontalLayoutGraphAutostop.addWidget(self.comboGraphAutostop)
        self.spinGraphAutostopThreshold = QtWidgets.QDoubleSpinBox(DialogGraphics)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setBold(True)
        ...
        self.horizontalLayoutGraphAutostop.addWidget(self.spinGraphAutostopThreshold)
        self.verticalLayout.addLayout(self.horizontalLayoutGraphAutostop)
        self.lineGraphTriggers = QtWidgets.QFrame(DialogGraphics)
        self.lineGraphTriggers.setFrameShape(QtWidgets.QFrame.HLine)
        self.lineGraphTriggers.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.lineGraphTriggers.setObjectName("lineGraphTriggers")
        self.verticalLayout.addWidget(self.lineGraphTriggers)
    ...
    def retranslateUi(self, DialogGraphics):
        ...
        self.labelDeviceLayout.setText(_translate("DialogGraphics", "设备布局"))
        ...
        self.comboDeviceLayout.setItemText(0, _translate("DialogGraphics", "全部显示"))
        self.comboDeviceLayout.setItemText(1, _translate("DialogGraphics", "单个显示"))
        self.labelGraphLayout.setText(_translate("DialogGraphics", "图形布局"))
        self.comboGraphLayout.setItemText(0, _translate("DialogGraphics", "共享"))
        self.comboGraphLayout.setItemText(1, _translate("DialogGraphics", "每设备独立"))
        ...
        self.labelGraphTriggerDevice.setText(_translate("DialogGraphics", "触发设备"))
        self.labelGraphAutostart.setText(_translate("DialogGraphics", "自动开始"))
        self.comboGraphAutostart.setItemText(0, _translate("DialogGraphics", "关闭"))
        self.comboGraphAutostart.setItemText(1, _translate("DialogGraphics", "电压"))
        self.comboGraphAutostart.setItemText(2, _translate("DialogGraphics", "电流"))
        self.labelGraphAutostop.setText(_translate("DialogGraphics", "自动停止"))
        self.comboGraphAutostop.setItemText(0, _translate("DialogGraphics", "关闭"))
        self.comboGraphAutostop.setItemText(1, _translate("DialogGraphics", "电压"))
        self.comboGraphAutostop.setItemText(2, _translate("DialogGraphics", "电流"))
