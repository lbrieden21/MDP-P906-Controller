...
# Form implementation generated from reading ui file 'gui_source/mdp_gui_template/settings.ui'
#
...
class Ui_DialogSettings(object):
    def setupUi(self, DialogSettings):
        ...
        DialogSettings.resize(340, 654)
        DialogSettings.setMinimumSize(QtCore.QSize(340, 654))
        DialogSettings.setMaximumSize(QtCore.QSize(340, 654))
        ...
        self.horizontalLayout_wifiTransport = QtWidgets.QHBoxLayout()
        self.horizontalLayout_wifiTransport.setObjectName("horizontalLayout_wifiTransport")
        self.label_wifiTransport = QtWidgets.QLabel(DialogSettings)
        self.label_wifiTransport.setMinimumSize(QtCore.QSize(0, 28))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.label_wifiTransport.setFont(font)
        self.label_wifiTransport.setAlignment(QtCore.Qt.AlignCenter)
        self.label_wifiTransport.setObjectName("label_wifiTransport")
        self.horizontalLayout_wifiTransport.addWidget(self.label_wifiTransport)
        self.comboBoxTransport = QtWidgets.QComboBox(DialogSettings)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.comboBoxTransport.setFont(font)
        self.comboBoxTransport.setObjectName("comboBoxTransport")
        self.comboBoxTransport.addItem("")
        self.comboBoxTransport.addItem("")
        self.horizontalLayout_wifiTransport.addWidget(self.comboBoxTransport)
        self.horizontalLayout_wifiTransport.setStretch(0, 2)
        self.horizontalLayout_wifiTransport.setStretch(1, 3)
        self.verticalLayout.addLayout(self.horizontalLayout_wifiTransport)
        self.horizontalLayout_wifiHostPort = QtWidgets.QHBoxLayout()
        self.horizontalLayout_wifiHostPort.setObjectName("horizontalLayout_wifiHostPort")
        self.label_wifiHostPort = QtWidgets.QLabel(DialogSettings)
        self.label_wifiHostPort.setMinimumSize(QtCore.QSize(0, 28))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.label_wifiHostPort.setFont(font)
        self.label_wifiHostPort.setAlignment(QtCore.Qt.AlignCenter)
        self.label_wifiHostPort.setObjectName("label_wifiHostPort")
        self.horizontalLayout_wifiHostPort.addWidget(self.label_wifiHostPort)
        self.frame_wifiHostPort = QtWidgets.QFrame(DialogSettings)
        self.frame_wifiHostPort.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_wifiHostPort.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_wifiHostPort.setObjectName("frame_wifiHostPort")
        self.horizontalLayout_wifiHostPortInner = QtWidgets.QHBoxLayout(self.frame_wifiHostPort)
        self.horizontalLayout_wifiHostPortInner.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_wifiHostPortInner.setSpacing(4)
        self.horizontalLayout_wifiHostPortInner.setObjectName("horizontalLayout_wifiHostPortInner")
        self.lineEditHost = QtWidgets.QLineEdit(self.frame_wifiHostPort)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.lineEditHost.setFont(font)
        self.lineEditHost.setText("")
        self.lineEditHost.setObjectName("lineEditHost")
        self.horizontalLayout_wifiHostPortInner.addWidget(self.lineEditHost)
        self.label_wifiPortColon = QtWidgets.QLabel(self.frame_wifiHostPort)
        self.label_wifiPortColon.setMaximumSize(QtCore.QSize(10, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.label_wifiPortColon.setFont(font)
        self.label_wifiPortColon.setAlignment(QtCore.Qt.AlignCenter)
        self.label_wifiPortColon.setObjectName("label_wifiPortColon")
        self.horizontalLayout_wifiHostPortInner.addWidget(self.label_wifiPortColon)
        self.spinBoxTcpPort = QtWidgets.QDoubleSpinBox(self.frame_wifiHostPort)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.spinBoxTcpPort.setFont(font)
        self.spinBoxTcpPort.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.spinBoxTcpPort.setDecimals(0)
        self.spinBoxTcpPort.setMinimum(1.0)
        self.spinBoxTcpPort.setMaximum(65535.0)
        self.spinBoxTcpPort.setSingleStep(1.0)
        self.spinBoxTcpPort.setProperty("value", 9000.0)
        self.spinBoxTcpPort.setObjectName("spinBoxTcpPort")
        self.horizontalLayout_wifiHostPortInner.addWidget(self.spinBoxTcpPort)
        self.horizontalLayout_wifiHostPortInner.setStretch(0, 3)
        self.horizontalLayout_wifiHostPortInner.setStretch(2, 2)
        self.horizontalLayout_wifiHostPort.addWidget(self.frame_wifiHostPort)
        self.horizontalLayout_wifiHostPort.setStretch(0, 2)
        self.horizontalLayout_wifiHostPort.setStretch(1, 3)
        self.verticalLayout.addLayout(self.horizontalLayout_wifiHostPort)
        ...
        self.horizontalLayout_deviceSelect = QtWidgets.QHBoxLayout()
        self.horizontalLayout_deviceSelect.setObjectName("horizontalLayout_deviceSelect")
        self.label_deviceSelect = QtWidgets.QLabel(DialogSettings)
        self.label_deviceSelect.setMinimumSize(QtCore.QSize(0, 28))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.label_deviceSelect.setFont(font)
        self.label_deviceSelect.setAlignment(QtCore.Qt.AlignCenter)
        self.label_deviceSelect.setObjectName("label_deviceSelect")
        self.horizontalLayout_deviceSelect.addWidget(self.label_deviceSelect)
        self.comboBoxDevice = QtWidgets.QComboBox(DialogSettings)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        ...
        self.btnDeviceRemove.setMaximumSize(QtCore.QSize(28, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        ...
        self.horizontalLayout_deviceSelect.setStretch(1, 3)
        self.verticalLayout.addLayout(self.horizontalLayout_deviceSelect)
        ...
        self.checkBoxIgnoreHWLock = QtWidgets.QCheckBox(self.frame_2)
        self.checkBoxIgnoreHWLock.setMinimumSize(QtCore.QSize(0, 28))
        self.checkBoxIgnoreHWLock.setObjectName("checkBoxIgnoreHWLock")
        self.verticalLayout_2.addWidget(self.checkBoxIgnoreHWLock)
    ...
    def retranslateUi(self, DialogSettings):
        ...
        self.label_wifiTransport.setText(_translate("DialogSettings", "连接方式"))
        self.comboBoxTransport.setItemText(0, _translate("DialogSettings", "USB / 串口"))
        self.comboBoxTransport.setItemText(1, _translate("DialogSettings", "WiFi (TCP)"))
        self.label_wifiHostPort.setText(_translate("DialogSettings", "主机地址"))
        self.lineEditHost.setPlaceholderText(_translate("DialogSettings", "192.168.1.100"))
        self.label_wifiPortColon.setText(_translate("DialogSettings", ":"))
        ...
        self.btnDeviceRemove.setText(_translate("DialogSettings", "-"))
        ...
        self.checkBoxIgnoreHWLock.setToolTip(_translate("DialogSettings", "硬件锁定时仍允许上位机修改输出状态"))
        self.checkBoxIgnoreHWLock.setText(_translate("DialogSettings", "忽略硬件锁定"))
