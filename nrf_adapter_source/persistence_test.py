...
if args.phase == "arm":
    ...
    print(f"  venv/bin/python nrf_adapter_source/persistence_test.py --port {PORT} --phase verify")
    sys.exit(0)
    ...
    if not fails:
        ...
        print(f"  venv/bin/python nrf_adapter_source/persistence_test.py --port {PORT} --phase restore")
